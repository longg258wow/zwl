...
public class TestZookeeper implements Watcher{
    ...
    public static void main(String[] args) throws Exception {
         ...
         * 之后会话状态为 CONNECTED
         */
        ZooKeeper zookeeper1 = new ZooKeeper("192.168.137.129:2181", 5000, new TestZookeeper());
...
//        ZooKeeper zookeeper2 = new ZooKeeper("192.168.137.129:2181", 5000, new TestZookeeper(),sessionId,sessionPasswd);
...
//        Thread.sleep(20000);
         ...
         *
         */
        byte[] data = zookeeper1.getData("/xx4", new TestZookeeper(), new Stat());
...
//        System.out.println(acl);
    ...
    public void process(WatchedEvent event) {
        ...
        if(event.getState() == KeeperState.SyncConnected){
            System.out.println("zookeeper状态 : " + KeeperState.SyncConnected);
        }
    }
}